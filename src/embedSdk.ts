...
const EmbedSDK = {
    ...
    showEmbedView() {
        ...
        embedViewElement.classList.add('modal');
        embedViewElement.classList.add('modal-open');
        ...
        const modalCloseBtn = document.querySelector(`#${rootId} .modal-header .modal-close-btn`);
